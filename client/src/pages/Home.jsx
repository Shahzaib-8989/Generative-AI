...
const HomeContainer = styled.div`
  ...
  padding-top: calc(80px + ${({ theme }) => theme.spacing.xl}); /* Account for fixed navbar */
...
const Home = () => {
  ...
  const fetchPosts = async (search = '') => {
    try {
      ...
      const mockData = [
        { _id: '1', name: 'Demo User', prompt: 'Futuristic cityscape at night', photo: 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=400&h=600&fit=crop' },
        { _id: '2', name: 'AI Artist', prompt: 'Mountain landscape with aurora', photo: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&h=500&fit=crop' },
        { _id: '3', name: 'Creative Mind', prompt: 'Space nebula with stars', photo: 'https://images.unsplash.com/photo-1419242902214-272b3f66ee7a?w=400&h=700&fit=crop' },
        { _id: '4', name: 'Digital Creator', prompt: 'Abstract digital art', photo: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=400&h=450&fit=crop' },
        { _id: '5', name: 'Cyber Artist', prompt: 'Cyberpunk street scene', photo: 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=400&h=550&fit=crop' },
        { _id: '6', name: 'Fantasy Creator', prompt: 'Fantasy forest landscape', photo: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&h=650&fit=crop' }
      ];
      setPosts(mockData);
    } finally {
      setLoading(false);
        ...
        <ImageGrid>
          {posts.length > 0 ? (
            ...
            <div style={{
              ...
              {searchLoading ? 'Searching...' : (searchQuery ? `No posts found for "${searchQuery}"` : 'No posts available')}
            </div>
          )}
        </ImageGrid>
      </HomeContainer>
